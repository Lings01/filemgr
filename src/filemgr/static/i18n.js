...
const I18N = {
  zh: {
    ...
    'toolbar.upload': '上传',
    'toolbar.mkdir': '新文件夹',
    'toolbar.search.placeholder': '搜索文件名（回车全局搜索）',
    ...
    'list.searchLocalEmpty': '当前目录无匹配。按 Enter 搜索整个家目录。',
    ...
    // 搜索 banner
    'searchBanner.searching': '全局搜索中… <strong>{0}</strong>',
    'searchBanner.found': '全局搜索 <strong>{0}</strong> · 找到 {1} 项{2}',
  ...
  en: {
    ...
    'toolbar.search.placeholder': 'Search file names (Enter for global search)',
    ...
    'list.searchLocalEmpty': 'No matches here. Press Enter to search the whole home directory.',
    ...
    'searchBanner.searching': 'Searching globally… <strong>{0}</strong>',
    'searchBanner.found': 'Global search <strong>{0}</strong> · {1} match(es){2}',
